    ...
    async fn send_notification(&self, notification: &Notification) -> Result<()> {
        ...
        let message = SlackMessage {
            ...
            attachments: vec![SlackAttachment {
                ...
                author_name: notification.task.channel_name.clone(),
                author_link: format!("https://www.youtube.com/channel/{}", notification.task.channel_id),
                author_icon: notification.task.channel_picture.clone(),
